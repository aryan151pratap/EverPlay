...
const Leftbar = function({currentTab, setCurrentTab, setUser, user}){
	...
	return(
		<div className="shrink-0 sm:bg-zinc-900/80 md:bg-zinc-900/0 h-full md:p-1 flex md:py-2">
			<div className="w-full p-1 md:bg-zinc-900/80 md:rounded-md border border-black h-full flex flex-row md:flex-col gap-2">
